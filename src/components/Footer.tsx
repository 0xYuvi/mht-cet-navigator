    ...
    <footer className="bg-neutral-800 text-white py-12">
      <div className="container mx-auto">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center">
                <span className="text-neutral font-bold text-xl">M</span>
              </div>
              <h2 className="text-xl font-bold">MHT-CET Navigator</h2>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-neutral-300">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>info@mhtcetnavigator.com</span>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-neutral-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">© {new Date().getFullYear()} MHT-CET Navigator. All rights reserved.</p>
