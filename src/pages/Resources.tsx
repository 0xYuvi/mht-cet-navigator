          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="card-hover">
                ...
                <CardContent>
                  <p>Our AI model analyzes historical MHT-CET data to accurately convert your raw score to expected percentile, helping you gauge your position among other candidates.</p>
                </CardContent>
              </Card>
              ...
              <Card className="card-hover">
                ...
                <CardContent>
                  <p>Get a tailored list of colleges based on your preferences for location, branch, facilities, and many other factors combined with your expected rank.</p>
                </CardContent>
              </Card>
              ...
              <Card className="card-hover">
                ...
                <CardContent>
                  <p>Our AI assistant helps you plan your CAP rounds strategically by analyzing past cutoff trends and suggesting the best preference order for your choices.</p>
                </CardContent>
              </Card>
            </div>
          </div>
